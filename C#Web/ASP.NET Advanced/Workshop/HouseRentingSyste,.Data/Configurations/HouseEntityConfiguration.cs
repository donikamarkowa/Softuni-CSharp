namespace HouseRentingSystem.Data.Configurations
{
    ...
    using static HouseRentingSystem.Common.EntityValidationsConstants;
    ...
    public class HouseEntityConfiguration : IEntityTypeConfiguration<House>
    {
        ...
        {
            ICollection<Models.House> houses = new HashSet<House>();
            ...
            house = new House()
            {
                ...
                CategoryId = 3,
                AgentId = Guid.Parse("3ADA170C-705D-427D-845A-A3F5E0698431"), //AgentId
                RenterId = Guid.Parse("83F3CA42-8A1A-418B-8F26-08DB76E0AD82"), //UserId
            };
            houses.Add(house);
